...
class MinesweeperWindow extends JFrame {
  ...
  val newGame = new JLabel(new ImageIcon("src/resource/img/nwGame.png"))
  val squareIcon = new ImageIcon("src/resource/img/square.png")
  val flagIcon = new ImageIcon("src/resource/img/flag.png")
  val bombIcon = new ImageIcon("src/resource/img/bomb.png")
  val emptyIcon = new ImageIcon("src/resource/img/empty.png")
